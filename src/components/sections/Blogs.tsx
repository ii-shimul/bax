...
const Blogs = () => {
	return (
		<section className="py-5 md:py-16 px-4 md:px-10 max-w-240 mx-auto w-full" id="blog">
			...
			<div className="flex flex-col gap-4">
				{blogs.map((blog) => (
					<article
						key={blog.id}
						className="group flex flex-col md:flex-row md:items-baseline gap-2 md:gap-8 py-1 md:p-6 rounded-xl hover:bg-gray-50 dark:hover:bg-card-dark transition-colors cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-border-dark"
					>
