			...
			<div className="flex justify-between items-end mt-6">
				<div className="flex -space-x-2">
					{project.technologies.slice(0, 3).map((tech) => (
						<div
							key={tech}
							className="h-8 w-8 rounded-full border border-card-dark bg-gray-800 flex items-center justify-center text-[10px] text-white font-bold"
							title={tech}
						>
	...
	<article className="lg:col-span-2 group relative overflow-hidden rounded-xl bg-card-dark border border-border-dark cyber-glow-box transition-all duration-300 flex flex-col md:flex-row">
		<div className="w-full md:w-1/2 p-8 flex flex-col justify-center relative z-10">
			...
			<div className="flex gap-4">
				...
				<a
					className="inline-flex items-center gap-2 text-gray-400 font-bold hover:text-primary transition-colors w-fit"
	...
	return (
		<section className="py-24 px-4 md:px-10 max-w-6xl mx-auto w-full" id="work">
			<div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
				...
				<BeforeEffectButton className="flex items-center cursor-pointer pt-1.5 gap-1 text-white font-bold hover:text-primary transition-colors group">
					View All Projects{" "}
