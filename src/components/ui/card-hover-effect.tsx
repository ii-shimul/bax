			...
			{items.map((item, idx) => (
				...
				>
					...
					<div
						...
						className="rounded-xl h-full w-full p-4 sm:p-4 overflow-hidden bg-gray-200 dark:bg-background-dark border border-gray-200 dark:border-border-dark group-hover:border-primary/50 group-hover:shadow-[0_0_15px_rgba(239,68,68,0.15)] relative z-20 transition-[border-color,box-shadow] duration-300"
					>
